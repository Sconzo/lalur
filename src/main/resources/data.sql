...
INSERT INTO tb_parametros_tributarios (
    ...
    ('01', 'QUALIFICACAO_PJ', 'PJ em Geral', 'ACTIVE', CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP),
    ('02', 'QUALIFICACAO_PJ', 'PJ Componente do Sistema Financeiro', 'ACTIVE', CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP),
    ('03', 'QUALIFICACAO_PJ', 'Sociedades Seguradoras, de Capitalização e Previdência', 'ACTIVE', CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP),
